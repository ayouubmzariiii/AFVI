...
<div class="page-banner">
    <div class="container">
        <h1><?php echo esc_html__('Actualités', 'afvi'); ?></h1>
        <div class="breadcrumbs">
            <a href="<?php echo esc_url(home_url('/')); ?>"><?php echo esc_html__('Accueil', 'afvi'); ?></a>
            <span>/</span>
            <span><?php echo esc_html__('Actualités', 'afvi'); ?></span>
        </div>
    </div>
</div>
        ...
        <div class="content-grid">
            <main>
                ...
                <div class="text-center" style="padding: var(--space-4xl) 0;">
                    ...
                    <p><?php echo esc_html__('Il n\'y a pas encore d\'articles publiés. Revenez bientôt !', 'afvi'); ?></p>
                </div>
                <?php endif; ?>
            </main>
            <aside class="sidebar">
